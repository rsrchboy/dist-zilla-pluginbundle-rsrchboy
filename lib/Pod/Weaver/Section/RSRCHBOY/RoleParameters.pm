...
{
  $Pod::Weaver::Section::RSRCHBOY::RoleParameters::VERSION = '0.039';
}
...
This document describes version 0.039 of Pod::Weaver::Section::RSRCHBOY::RoleParameters - released April 22, 2013 as part of Dist-Zilla-PluginBundle-RSRCHBOY.
