...
{
  $Pod::Weaver::Section::RSRCHBOY::RoleParameters::VERSION = '0.038';
}
...
This document describes version 0.038 of Pod::Weaver::Section::RSRCHBOY::RoleParameters - released March 29, 2013 as part of Dist-Zilla-PluginBundle-RSRCHBOY.
